...
print '<A HREF="/tt/htm/tt.htm">ThoughtTreasure home</A>'
print '<HR NOSHADE SIZE=3>'
print '<CENTER><FONT SIZE=2>Questions or comments?'
print '<A HREF="mailto:webmaster@signiform.com">webmaster@signiform.com</FONT></A>'
print '<BR><A HREF="/index/legal.htm"><FONT SIZE=2>Copyright &copy; 2000 Signiform.'
print 'All Rights Reserved. Terms of use.</A></FONT></CENTER>'
print '<HR NOSHADE SIZE=3>'
print '</body>'
print '</html>'
