 ...
 * 19981113: port to Red Hat Linux 5.2 / passes "gcc -Wall"
 */
...
{
  StreamSep(stream);
fprintf(stream, "ThoughtTreasure version 0.00022 of 19991208 (");
/* exhaustive ifdefs */
#ifdef GCC
fprintf(stream, "gcc)\n");
#endif
...
fprintf(stream, "NEXT)\n");
#endif
fprintf(stream, "Copyright 1996, 1997, 1998, 1999 Erik Thomas Mueller. All Rights Reserved.\n");
fprintf(stream, "Bugs to bugs@signiform.com.\n");
fprintf(stream,
