...
SET CLP=%CLP%;%SHARPINSTALL%\platform\bin\agents\ams.jar

SET CMD=java -classpath %CLP% br.usp.talkagent.ams.XTest

rem SET AMS=ams.jar
rem SET AMSAGT=..\agents\%AMS%
rem SET CMD=java -jar %AMSAGT%
