...
class UclInterpreterConnector extends SharpAgent
{
...
public UclInterpreterConnector() throws Exception 
{
	super();
	ucl_ok = false;
	error = false;
...
addressParser addr;
	...
	try
	{
		...
		UCLAgent = 	amsclient.getAgentID("sharp_ucl_converter");
		...
		{
			error = true;
			throw new Exception("== Error: UCL Converter Agent not found " + amsclient.getAmsAddr());			
		}		
